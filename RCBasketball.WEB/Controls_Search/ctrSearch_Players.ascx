<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ctrSearch_Players.ascx.vb" Inherits="RCBasketball.WEB.ctrSearch_Players" %>

<asp:ScriptManager ID="ScriptManager2" runat="server"></asp:ScriptManager>
                        You can use a partial Player ID in your search
                       <asp:Table ID="Table1" runat="server" ForeColor="#0000A0" >
                             <asp:TableRow>
                                          <asp:TableCell>Player Name:&nbsp;&nbsp;</asp:TableCell>
                                          <asp:TableCell>
